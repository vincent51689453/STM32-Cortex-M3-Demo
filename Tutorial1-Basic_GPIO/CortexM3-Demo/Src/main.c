...
/**
  ...
  * @brief          : Main program body
	...
	* @content        : M3 Demo - Basic GPIO Input/Output
	* @version        : Tutorial 1
  ******************************************************************************
  * @attention
  * This program is written for STM32F103RB Nucleo Board. This program is to 
  * demonstrate how to control the built in LED (ON/OFF) by the Blue button
  * on the Nucleo Board.
  *
  ******************************************************************************
  */
...
int main(void)
{
  ...
  while (1)
  {
		if(HAL_GPIO_ReadPin(USER_BUTTON_GPIO_Port,USER_BUTTON_Pin) == GPIO_PIN_RESET)       //Check whether BUTTON is pressed
		{
